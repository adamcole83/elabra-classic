...
class Paginator {
	...
	function Paginator()
	{
		...
		$this->current_page = 1;
		$this->mid_range = 7;
		$this->items_per_page = (isset( $ipp ) && !empty( $ipp )) ? $ipp : $this->default_ipp;
	...
	function paginate()
	{
		...
		$this->current_page = (int) $this->items_per_page; // must be numeric > 0
		...
		if($this->num_pages > 10)
		{
			...
			for($i=1;$i<=$this->num_pages;$i++)
			{
				...
				{
					$this->return .= ($i == $this->current_page And $this->page != 'All') ? "<li><a title=\"Go to page $i of $this->num_pages\" class=\"active\" href=\"#\">$i</a></li> ":"<li><a title=\"Go to page $i of $this->num_pages\" href=\"$_SERVER[PHP_SELF]?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a></li> ";
				}
				if($this->range[$this->mid_range-1] < $this->num_pages-1 And $i == $this->range[$this->mid_range-1]) $this->return .= "<li class=\"continued\"> ... </li>";
			}
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($this->page != 'All')) ? "<li class=\"next\"><a href=\"$_SERVER[PHP_SELF]?page=$next_page&ipp=$this->items_per_page$this->querystring\">Next &raquo;</a></li>":"<li class=\"next-off\" href=\"#\">Next &raquo;</li>";
			$this->return .= ($this->page == 'All') ? "<li><a class=\"active\" style=\"margin-left:10px\" href=\"#\">All</a></li> ":"<li><a style=\"margin-left:10px\" href=\"$_SERVER[PHP_SELF]?page=All&ipp=All$this->querystring\">All</a></li> ";
		}
		else
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<li class=\"previous\"><a href=\"$_SERVER[PHP_SELF]?page=$prev_page&ipp=$this->items_per_page$this->querystring\">&laquo; Previous</a></li> ":"<li class=\"previous-off\" href=\"#\">&laquo; Previous</li> ";
			...
			if($this->page != 'All') {
				for($i=1;$i<=$this->num_pages;$i++)
				{
					$this->return .= ($i == $this->current_page And $this->page != 'All') ? "<li><a class=\"active\" href=\"#\">$i</a></li> ":"<li><a href=\"$_SERVER[PHP_SELF]?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a></li> ";
				}
			}else{
				$this->return .= "<li><a href=\"$_SERVER[PHP_SELF]?page=1&ipp=$this->items_per_page$this->querystring\">1</a></li>";
			}

			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($this->page != 'All')) ? "<li><a href=\"$_SERVER[PHP_SELF]?page=$next_page&ipp=$this->items_per_page$this->querystring\">Next &raquo;</a></li>":"<li class=\"next-off\">Next &raquo;</li>";
