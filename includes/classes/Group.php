...
class Group
{
	...
	public static function can($permission)
	{
        ...
        if(self::exists("permissions", array('id'=>$permission, "group_id"=>$session->user()->group_id)))
        	return true;
        else
        	return false;
	}
	...
	public static function add_group_permission($id, $permission)
	{
		...
		return $database->insert("permissions", array("id" => $permission, "group_id" => $id, "name" => camelize($permission)));
	}
