						...
						<? foreach(Department::listAvailable() as $dept): ?>
							...
							<td>
								<ul>
									...
									<li onclick="ChangeDepartment(<? echo $dept->id; ?>)"><span class="title <? echo $class; ?>"><? echo _tw($dept->name,35); ?></span> <small style="color:rgba(85,80,54,.4);">/<? echo $dept->subdir; ?></small></li>
								</ul>
							</td>
							<? $num++; ?>
						<? endforeach; ?>
