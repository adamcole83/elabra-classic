...
<html xmlns="https://www.w3.org/1999/xhtml">
	<head>
		<title>Media Manager &laquo; <? echo Department::find_by_id($_SESSION['department'])->name; ?> &laquo; Content Management System</title>
	...
	<body>
		...
		<div id="main">
			<div class="container">
				<div id="content">
					<? include("includes/layouts/".get_page_info('action')."_media.php") ?>
				</div>
			</div><!-- .container -->
		</div><!-- #main -->
		<div id="loader">
