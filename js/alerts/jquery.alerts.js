	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch (type) {
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.saveButton + '" id="popup_ok" /> <input type="button" value="' + $.alerts.dontsaveButton + '" id="popup_cancel" /></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
